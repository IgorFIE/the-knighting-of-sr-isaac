...
export class WeaponIcons {
  ...
  update() {
    ...
    this.leftCanv.style.translate =
      GameVars.gameW -
      this.leftCanv.width -
      toPixelSize(12) +
      "px " +
      (GameVars.gameH - this.leftCanv.height - toPixelSize(12)) +
      "px";
    this.rightCanv.style.translate =
      GameVars.gameW -
      this.leftCanv.width -
      toPixelSize(30 + 24) +
      "px " +

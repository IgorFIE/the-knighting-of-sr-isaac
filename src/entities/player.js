...
export class Player {
    constructor(roomX, roomY) {
        ...
        this.playerRightWeapon = new Weapon(0, 0, GameVars.lastPlayerRightWeaponType || WeaponType.HAMMER, -1, this, playerColors.hd);
        this.playerLeftWeapon = new Weapon(0, 0, GameVars.lastPlayerLeftWeaponType || WeaponType.HAMMER, 1, this, playerColors.hd);

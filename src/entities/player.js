...
export class Player {
    constructor(roomX, roomY) {
        ...
        this.playerRightWeapon = new Weapon(0, 0, GameVars.lastPlayerRightWeaponType || WeaponType.AXE, -1, this, playerColors.hd);
        this.playerLeftWeapon = new Weapon(0, 0, GameVars.lastPlayerLeftWeaponType || WeaponType.AXE, 1, this, playerColors.hd);
